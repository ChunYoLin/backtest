...
from libs.strategy import TrendTracking
...
def main():
    stock_pd = get_stock_pd(sys.argv[1], fetch_from=(2008, 1), scale="D", chip=True, mode="dynamic", update=True)
    ...
    cerebro.addstrategy(TrendTracking)
